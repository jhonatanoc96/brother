    ...
    <nav class="cat__menu-left">
        ...
        <div class="cat__menu-left__logo">
            <a href="<?php echo e(url('dashboard')); ?>">
                <img src="<?php echo asset('/dist/modules/dummy-assets/common/img/brother.jpg'); ?>" />
            </a>
        </div>
            ...
            <ul class="cat__menu-left__list cat__menu-left__list--root">
                ...
                <li class="cat__menu-left__item cat__menu-left__submenu">
                    <a href="javascript: void(0);">
                        <span class="cat__menu-left__icon icmn-sphere cat__core__spin-delayed--pseudo-selector"></span>
                        Website (CMS)
                    </a>
                ...
                <li class="cat__menu-left__item cat__menu-left__submenu">
                    <a href="javascript: void(0);">
                        <span class="cat__menu-left__icon icmn-bubble cat__core__spin-delayed--pseudo-selector"></span>
                        Main Menu
                    </a>
                    <ul class="cat__menu-left__list">
                        <li class="cat__menu-left__item">
